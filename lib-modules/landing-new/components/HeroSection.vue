...
<template>
  <section class="relative min-h-screen flex flex-col items-center justify-center px-6 md:px-12 pt-28 pb-20 overflow-hidden">
    <div class="lnf-mono font-bold text-[11px] md:text-[12px] tracking-[0.1em] uppercase text-[#8a8a8a] dark:text-[#5a5550] mb-10 md:mb-14 lnu-fade-up" style="animation-delay:100ms">
      {{ t('landingNew.hero.label') }}
    </div>

    <h1 class="lnf-display font-extrabold text-center leading-[0.98] tracking-[-0.04em] text-[#0a0a0a] dark:text-[#ede8de] text-[40px] sm:text-[56px] md:text-[72px] lg:text-[88px]">
